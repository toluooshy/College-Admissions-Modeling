...
**Autocorrelation**, is the correlation of a series with a delayed copy of itself as a function of delay. We use autocorrelation to find repeating patterns in data in our data. The plot can provide answers to whether or not our data is white noise or random and if we could use a AR and/or MA model.
...
title("Autocorrelation of Total Yield Percentage")
```

ACF Plot of the Detrended Total Yield Percentage:
...
ACF Plot of the First Difference Total:
...
Knowing this, we can use ARIMA Modelling to measure events that happen over a period of time.
