...
abline(reg=lm(admissions_men_ts~time(admissions_yield_ts)), col='chartreuse4')
legend("topleft",
...
plot(admissions_women_ts, ylab = "Yield Percentage", main="Fitted Auto Regressive Admission Yield Model Over Time",col='black',ylim=c(40,90))
...
```
```{r}
ts.plot(admissions_men_ts, ylab = "Yield Percentage", main = "AR Predicted Men's Yield Over One Year", col = 'blue', xlim = c(2006, 2022), ylim = c(50, 90))
