...
Loading in admissions data (pre-formatted in Excel) from the [Integrated Postsecondary Education Data System](https://nces.ed.gov/ipeds/use-the-data) database.
...
```{r}
cor(AR_fitwomen, MA_fitwomen)
cor(AR_fitmen, MA_fitmen)
cor(AR_fitmen,AR_fitwomen)
