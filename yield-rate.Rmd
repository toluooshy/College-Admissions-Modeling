...
Loading in admissions data (pre-formatted in Excel) from the Integrated Postsecondary Education Data System, IPEDS. 
...
### Analyzing General Trend with a Linear Regression Line
...
Below, we use auto-correlation to determine what type of series we have: whether it is a white noise, random walk, auto regressive or moving average.
...
## Create Auto Regressive (AR) Model
...
ts.plot(admissions_yield_ts, ylab = "Yield Percentage", main = "AR Predicted Yield Over One Year", col = 'black', xlim = c(2002, 2022), ylim = c(45, 100))
```
Plotting the series along with the forecast prediction and 95% prediction intervals:

```{r}
ts.plot(admissions_yield_ts, ylab = "Yield Percentage", main = "AR Predicted Yield Over One Year", col = 'black', xlim = c(2000, 2031), ylim = c(40, 100),type='o')
...
## Analyzing General Linear Regression Lines
```{r}
...
### Men
```{r}
acf(admissions_men_ts, main="")
title("Autocorrelation of Men's Yield Percentage")
```
### Women
```{r}
acf(admissions_women_ts, main="")
title("Autocorrelation of Women's Yield Percentage")
```
## ARIMA Modeling
### Creating AR Models
```{r}
...
plot(admissions_women_ts, ylab = "Yield Percentage", main="Fitted Auto Regressive Admission Yield Model Over Time",col='black',ylim=c(50,100))

lines(admissions_men_ts, col = 'blue')

AR_fitwomen <- admissions_women_ts - residuals(ARwomen)
points(AR_fit_women, type = "l", col = 'red', lty = 2)

AR_fitmen <- admissions_men_ts - residuals(ARmen)
...
=======
ts.plot(admissions_women_ts, ylab = "Yield Percentage", main = "AR Predicted Women's Yield Over One Year", col = 'black', xlim = c(2002, 2022), ylim = c(0, 100),type='o')
>>>>>>> parent of 8750e12 (Extend ten years)
...
ts.plot(admissions_men_ts, ylab = "Yield Percentage", main = "AR Predicted Men's Yield Over Ten Years", col = 'blue', xlim = c(2006, 2031), ylim = c(50, 105))
=======
ts.plot(admissions_men_ts, ylab = "Yield Percentage", main = "AR Predicted Men's Yield Over One Year", col = 'black', xlim = c(2002, 2022), ylim = c(20, 100),type='o')
>>>>>>> parent of 8750e12 (Extend ten years)
...
```{r}
plot(admissions_women_ts, ylab = "Yield Percentage", main="Fitted Moving Average Admission Yield Model Over Time",col='black',ylim=c(45,100))
...
=======
ts.plot(admissions_women_ts, ylab = "Yield Percentage", main = "MA Predicted Women's Yield Model Over One Year", col = 'black', xlim = c(2002, 2022), ylim = c(20, 100),type='o')
>>>>>>> parent of 8750e12 (Extend ten years)
...
```{r}
<<<<<<< HEAD
ts.plot(admissions_men_ts, ylab = "Yield Percentage", main = "MA Predicted Men's Yield Model Over Ten Years", col = 'blue', xlim = c(2006, 2031), ylim = c(50, 105))
=======
ts.plot(admissions_men_ts, ylab = "Yield Percentage", main = "MA Predicted Men's Yield Model Over One Year", col = 'black', xlim = c(2002, 2022), ylim = c(20, 100),type='o')
>>>>>>> parent of 8750e12 (Extend ten years)
