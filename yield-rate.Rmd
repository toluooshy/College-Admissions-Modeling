...
# 3. General Analysis of Total Data
...
# 4. Analyzing our Data

Before heading into modelling, we can view more additional statistics about out data to determine the best model for future predictions.

## 4.1 First Difference

**First Difference** is the value between two different variables by subtracting the previous value from each. This variable is useful to help determine help determine whether there is a pattern and the nature of the pattern in a set of data.
...
## 5.1 AutoRegressive (AR) Modelling
...
## 5.2 Create Moving Average (MA) model 
...
# 7. Viewing Yield Rate Through The Men/Women Split
...
## 7.2 General Analysis of Gendered Data
...
## 7.3 Analyzing General Linear Regression Lines
