...
>>>>>>> 8750e125daa06c238214c4342234fbe075fc4c87
...
ts.plot(admissions_men_ts, ylab = "Yield Percentage", main = "AR Predicted Men's Yield Over One Year", col = 'blue', xlim = c(2006, 2022), ylim = c(50, 100))

AR_forecastmen <- predict(ARmen, n.ahead = 10)$pred
AR_forecastmen_se <- predict(ARmen, n.ahead = 10)$se
points(AR_forecastmen, type = "l", col = 'chartreuse4')
...
```{r}
ts.plot(admissions_men_ts, ylab = "Yield Percentage", main = "MA Predicted Men's Yield Model Over One Year", col = 'blue', xlim = c(2006, 2022), ylim = c(50, 100))
MA_forecastsmen <- predict(MAmen, n.ahead = 10)$pred
MA_forecastmen_se <- predict(MAmen, n.ahead = 10)$se
points(MA_forecastsmen, type = "l", col = 'chartreuse4')
